...
from api.routers import query, summary, quiz, keywords, mindmap, recommend, upload, folders, documents, labels
from api.routers import ocr_bridge, quiz_qa, reports
from api.routers import memos, highlights, graph_analysis
from api.routers import graph_hierarchical
...
app.include_router(graph_analysis.router, prefix="/graph-analysis", tags=["Graph Analysis"])
app.include_router(graph_hierarchical.router, prefix="/graph-hierarchical", tags=["Hierarchical Graph"])
