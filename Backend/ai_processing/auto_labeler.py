...
**키워드 추출 가이드라인:**
- 구체적이고 전문적인 용어를 우선하세요 (예: "데이터" → "빅데이터", "머신러닝")
- 브랜드명, 제품명, 기술명, 학술용어 등을 포함하세요
- 일반적이거나 추상적인 단어는 피하세요
...
**키워드 추출 가이드라인:**
- 구체적이고 전문적인 용어를 우선 선택하세요
- 예시: "데이터" → "빅데이터", "머신러닝", "데이터마이닝"
- 예시: "기술" → "블록체인", "인공지능", "클라우드컴퓨팅"
- 예시: "경제" → "핀테크", "디지털경제", "암호화폐"
- 브랜드명, 제품명, 기술명, 학술용어, 고유명사를 포함하세요
- "데이터", "기술", "사회", "정책" 같은 일반적인 단어는 피하세요
- 명사나 핵심 개념 위주로 선택하고, 구체적일수록 좋습니다
...
키워드 (최대 {max_keywords}개, 쉼표로 구분):"""
            ...
            if response:
                ...
                # 일반적인 단어 필터링 리스트 확장
                generic_words = {
                    '데이터', '기술', '사회', '정책', '경제', '문제', '방법', '시스템', 
                    '관리', '개발', '연구', '분석', '정보', '서비스', '프로그램',
                    '과정', '결과', '내용', '상황', '조건', '환경', '구조', '형태'
                }
                ...
                for keyword in raw_keywords:
                    ...
                    # 일반적인 단어 필터링 및 기타 조건 확인
                    if (clean_keyword and 
                        len(clean_keyword) >= 2 and 
                        len(clean_keyword) <= 20 and
                        clean_keyword not in generic_words and  # 일반적인 단어 제외
